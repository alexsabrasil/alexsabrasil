...
Soy desarrollador Front-End Jr. Ingeniera de datos autodidacta, actualmente estoy estudiando (Licenciatura) en Sistemas de Información en el Centro Universitário Unifatecie y terminé el bootcamp de Mujeres Ingenieras de Datos DataEX ON Demand, donde trabajé en la construcción de 1 NoteBook Data Pipeline con Azure Data Studio - habilidades de lenguaje SQL y T-SQL.

En formación en el curso de Front-End en Oracle Next Education (ONE) en Alura y gané una beca en Santander Brasil a través de la plataforma ADA Tech formación en Coders Comprometidos con evolucionar y colaborar en el desarrollo de personas y proyectos, aprendiendo sobre nuevas tecnologías y desafiándome a mí mismo en cada proyecto y practicando nuevos conocimientos en tecnología.
